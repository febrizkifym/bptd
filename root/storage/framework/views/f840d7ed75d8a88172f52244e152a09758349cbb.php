               ...
               <form action="<?php echo e(route('satpel.update',$sp->id)); ?>" method="post" enctype="multipart/form-data">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th>Tupoksi</th>
                        <td>
                            <textarea name="tupoksi" id="" cols="50" rows="2" readonly ondblclick="this.readOnly='';" onblur="this.readOnly=true"><?php echo e($sp->tupoksi); ?></textarea>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($sp->struktur): ?>
                                <a href="<?php echo e(url('storage/img').'/'.$sp->struktur); ?>"><img src="<?php echo e(url('storage/img').'/'.$sp->struktur); ?>" alt="" class="img-thumbnail"></a>
                            <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($sp->gambar): ?>
                                <a href="<?php echo e(url('storage/img').'/'.$sp->gambar); ?>"><img src="<?php echo e(url('storage/img').'/'.$sp->gambar); ?>" alt="" class="img-thumbnail"></a>
                            <?php else: ?>
                            <span class="label label-warning">Belum Diinput</span>
                            <div>(Ukuran foto yang disarakan = 1280x768)</div>
                            <?php endif; ?>
