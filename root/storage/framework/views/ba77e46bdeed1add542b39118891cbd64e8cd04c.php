...
<script>
    ...
    var titik = {
        ...
        "features": [
            <?php $__currentLoopData = $titik; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            { "type": "Feature", "id":"<?php echo e($t->id); ?>", "properties": { "tabel_kd": "<?php echo e($t->tabel_kd); ?>","ruas": "<?php echo e($t->nama); ?>","tahun": "<?php echo e($t->tahun); ?>","ket": "<?php echo e($t->ket); ?>"   }, "geometry": { "type": "Point", "coordinates": [<?php echo e($t->x); ?>, <?php echo e($t->y); ?>] }},
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ]
    };
    var warning = {
        ...
        "features": [
            <?php $__currentLoopData = $warning; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            { "type": "Feature", "id":"<?php echo e($t->id); ?>", "properties": { "tabel_kd": "<?php echo e($t->tabel_kd); ?>","ruas": "<?php echo e($t->nama); ?>","tahun": "<?php echo e($t->tahun); ?>","ket": "<?php echo e($t->ket); ?>"   }, "geometry": { "type": "Point", "coordinates": [<?php echo e($t->x); ?>, <?php echo e($t->y); ?>] }},
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ]
    }
