                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    <a href="/berkas_ppid/<?php echo e($p->file); ?>"><h3><i class="icon icon-download-alt"></i></h3></a>
                                </td>
                                <td>
                                <?php if(Auth::user()->role == 'admin'): ?>
                                    <a href="<?php echo e(route('ppid.edit',$p->id)); ?>"><button class="btn btn-warning btn-mini">Edit</button></a>
                                    <a href="<?php echo e(route('ppid.delete',$p->id)); ?>"><button class="btn btn-danger btn-mini">Hapus</button></a>
                                <?php endif; ?>
                                </td>
                            </tr>
                    ...
                    <form action="<?php echo e(route('ppid.post')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <th>Judul</th>
                                <td>
                                    <input type="text" name="judul" class="form-control" value="<?php echo e(old('ket')); ?>" required> 
                                </td>
                            </tr>
                            <tr>
                                <th>Deskripsi</th>
