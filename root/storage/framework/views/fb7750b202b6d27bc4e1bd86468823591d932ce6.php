                ...
                <form action="<?php echo e(route('ppid.update',$p->id)); ?>" method="post">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="date" name="tanggal" id="tanggal" class="form-control" value="<?php echo e($p->tanggal); ?>" required>
                            </td>
                        </tr>
                        <tr>
                            <th>Jenis PPID</th>
                        ...
                        <tr>
                            <th>Judul</th>
                            <td>
                                <input type="text" name="judul" class="form-control" value="<?php echo e($p->judul); ?>" required> 
                            </td>
                        </tr>
                        <tr>
                            <th>Deskripsi</th>
