                        ...
                        <table class="table table-bordered table-hover data-table">
                            ...
                            <tbody>
                                ...
                                @foreach ($ppid as $p)
                                    <tr>
                                        <td>{{ $no }}</td>
                                        <td>{{ \Carbon\Carbon::parse($p->tanggal)->formatLocalized('%d %B %Y') }}</td>
                                        <td>
                                            <?php
                                            switch ($p->jenis) {
                                                case 'berkala':
                                        ...
                                        <td style="text-align: center">
                                            <a href="/berkas_ppid/{{ $p->file }}">
                                                <h3><i class="icon icon-download-alt"></i></h3>
                                            </a>
                                        </td>
                                        <td>
                                            @if (Auth::user()->role == 'admin')
                                                <a href="{{ route('ppid.edit', $p->id) }}"><button
                                                        class="btn btn-warning btn-mini">Edit</button></a>
                                                <a href="{{ route('ppid.delete', $p->id) }}"><button
