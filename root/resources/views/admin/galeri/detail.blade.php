        ...
        <div class="widget-box">
          ...
          <h5>Tambah Foto</h5>
           ...
           <hr>
            ...
            <ul class="thumbnails">
             @foreach($galeri as $g)
              <li class="span2"> <a> <img src="{{url('storage/img/'.$g->path)}}" alt="" > </a>
                <div class="actions"> <a title="" class="" href="{{route('galeri.delete',$g->id)}}"><i class="icon-trash"></i></a> <a class="lightbox_trigger" href="{{url('storage/img/'.$g->path)}}"><i class="icon-picture"></i></a> </div>
              </li>
              @endforeach
            </ul>
