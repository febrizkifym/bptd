        ...
        <nav class="navbar first-navbar fixed-top navbar-expand-lg navbar-light bg-light container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown position-static {{ request()->is('profil*') ? 'active' : '' }}"><a
                            href="#"
                                ...
                                <div class="row w-100">
                                    <div class="text-center col-sm-4 mega-menu">
                                        ...
                                        @foreach (App\Satpel::all() as $sp)
                                            <a href="{{ route('satpel', [$sp->id, Str::slug($sp->nama, '-')]) }}"
                                                class="dropdown-item">{{ Str::limit($sp->nama, 28) }}</a>
                                        @endforeach
                                    </div>
                                    <div class="text-center col-sm-4 mega-menu">
                                        ...
                                        <a href="{{ route('sejarah') }}" class="dropdown-item">Sejarah BPTD</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('kegiatan*') ? 'active' : '' }}"
                            href="{{ route('berita') }}">Kegiatan</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle {{ request()->is('ppid*') ? 'active' : '' }}" href="#"
